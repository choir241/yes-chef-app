...
router.get("/metrics/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id_1, client, db, collection, ingredients, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, collection.find(function () { _id: id_1; }).toArray()];
            case 2:
                ingredients = _a.sent();
...
router.post("/metrics", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ingredientNames, client, db, collection, newIngredients, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                ingredientNames = req.body.ing;
                return [4 /*yield*/, (0, config_ts_1.Client_Connect)()];
            case 1:
                client = _a.sent();
            ...
            case 3:
                err_2 = _a.sent();
                console.error("Failed to fetch ingredients: ", err_2);
                process.exit(1);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
