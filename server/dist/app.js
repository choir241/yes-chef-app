...
router3.post("/addToKitchen", (req, res) => __async(void 0, null, function* () {
  try {
    const client = yield Client_Connect();
...
var kitchen_default = router3;

// server/controllers/metrics.ts
import express4 from "express";
import { ObjectId as ObjectId2 } from "mongodb";
var router4 = express4.Router();
router4.get("/metrics/:id", (req, res) => __async(void 0, null, function* () {
  try {
...
router4.post("/metrics", (req, res) => __async(void 0, null, function* () {
  try {
...
router5.get("/api/distributor/search/:query", getDistributorIngredients);
var distributorRoutes_default = router5;
...
function startServer() {
  return __async(this, null, function* () {
    try {
      ...
      const app2 = express6();
      app2.use(cors());
      app2.use(express6.urlencoded({ extended: true }));
      app2.use(express6.json());
      console.log("Connect to the database");
      app2.use("/", ingredient_default, kitchen_default, order_default, metrics_default, distributorRoutes_default);
