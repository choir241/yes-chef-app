...
<div className="sb-container">
  <div className="sb-section">
    <div className="sb-section-item">
      <h4 className="sb-section-item-heading">Planning</h4>
      <p className="sb-section-item-paragraph">See what went into the planning process for the application, the thought process, and the design process.</p>
      <a
        href="/?path=/docs/planning--docs"
      >Learn more</a>
    </div>
    <div className="sb-section-item">
